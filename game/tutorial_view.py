...
class TutorialView(GameView):
    ...
    def _gu_pet_embed(self) -> discord.Embed:
        ...
        embed.description = (
            ...
            "hatch a blank Rank I-VII Gu Pet. Any rank is attemptable at any Gu Refiner rank — "
            "reaching for a rank above your own level just costs success chance instead of "
            "being blocked outright, and a higher Gu Refiner rank improves your odds "
            "everywhere.\n"
